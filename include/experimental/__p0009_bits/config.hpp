...
#ifdef _MSVC_LANG
#define MDSPAN_CPLUSPLUS _MSVC_LANG
#else
#define MDSPAN_CPLUSPLUS __cplusplus
#endif
...
#define MDSPAN_HAS_CXX_14 (MDSPAN_CPLUSPLUS >= MDSPAN_CXX_STD_14)
#define MDSPAN_HAS_CXX_17 (MDSPAN_CPLUSPLUS >= MDSPAN_CXX_STD_17)
#define MDSPAN_HAS_CXX_20 (MDSPAN_CPLUSPLUS >= MDSPAN_CXX_STD_20)
#define MDSPAN_HAS_CXX_23 (MDSPAN_CPLUSPLUS >= MDSPAN_CXX_STD_23)

static_assert(MDSPAN_CPLUSPLUS >= MDSPAN_CXX_STD_14, "mdspan requires C++14 or later.");

#ifndef MDSPAN_COMPILER_CLANG
#  if defined(__clang__)
#    define MDSPAN_COMPILER_CLANG __clang__
#  endif
#endif

#if !defined(MDSPAN_COMPILER_MSVC) && !defined(MDSPAN_COMPILER_MSVC_CLANG)
#  if defined(_MSC_VER)
#    if !defined(MDSPAN_COMPILER_CLANG)
#      define MDSPAN_COMPILER_MSVC _MSC_VER
#    else
#      define MDSPAN_COMPILER_MSVC_CLANG _MSC_VER
#    endif
#  endif
#endif

#ifndef MDSPAN_COMPILER_INTEL
#  ifdef __INTEL_COMPILER
#    define MDSPAN_COMPILER_INTEL __INTEL_COMPILER
#  endif
#endif

#ifndef MDSPAN_COMPILER_APPLECLANG
#  ifdef __apple_build_version__
#    define MDSPAN_COMPILER_APPLECLANG __apple_build_version__
#  endif
#endif

#ifndef MDSPAN_HAS_CUDA
#  if defined(__CUDACC__)
#    define MDSPAN_HAS_CUDA __CUDACC__
#  endif
#endif

#ifndef MDSPAN_HAS_HIP
#  if defined(__HIPCC__)
#    define MDSPAN_HAS_HIP __HIPCC__
#  endif
#endif

#ifndef MDSPAN_HAS_SYCL
#  if defined(SYCL_LANGUAGE_VERSION)
#    define MDSPAN_HAS_SYCL SYCL_LANGUAGE_VERSION
#  endif
#endif
...
#ifndef MDSPAN_PRESERVE_STANDARD_LAYOUT
...
#  define MDSPAN_PRESERVE_STANDARD_LAYOUT 1
#endif
...
#  if ((MDSPAN_IMPL_HAS_CPP_ATTRIBUTE(no_unique_address) >= 201803L) && \
       ...
       (!defined(MDSPAN_COMPILER_MSVC) || MDSPAN_HAS_CXX_20))
#    define MDSPAN_USE_ATTRIBUTE_NO_UNIQUE_ADDRESS 1
#    define MDSPAN_NO_UNIQUE_ADDRESS [[no_unique_address]]
#  else
#    define MDSPAN_NO_UNIQUE_ADDRESS
#  endif
#endif
...
#ifndef MDSPAN_NO_UNIQUE_ADDRESS
#  if defined(__NVCC__)
#    define MDSPAN_USE_ATTRIBUTE_NO_UNIQUE_ADDRESS 1
#    define MDSPAN_USE_FAKE_ATTRIBUTE_NO_UNIQUE_ADDRESS
#  endif
#  define MDSPAN_NO_UNIQUE_ADDRESS
#endif
...
#ifndef MDSPAN_USE_FOLD_EXPRESSIONS
#  if (defined(__cpp_fold_expressions) && __cpp_fold_expressions >= 201603L) \
          || (!defined(__cpp_fold_expressions) && MDSPAN_HAS_CXX_17)
#    define MDSPAN_USE_FOLD_EXPRESSIONS 1
#  endif
#endif

#ifndef MDSPAN_USE_INLINE_VARIABLES
#  if defined(__cpp_inline_variables) && __cpp_inline_variables >= 201606L \
         || (!defined(__cpp_inline_variables) && MDSPAN_HAS_CXX_17)
#    define MDSPAN_USE_INLINE_VARIABLES 1
#  endif
#endif

#ifndef MDSPAN_NEEDS_TRAIT_VARIABLE_TEMPLATE_BACKPORTS
#  if (!(defined(__cpp_lib_type_trait_variable_templates) && __cpp_lib_type_trait_variable_templates >= 201510L) \
          || !MDSPAN_HAS_CXX_17)
#    if !(defined(MDSPAN_COMPILER_APPLECLANG) && MDSPAN_HAS_CXX_17)
#      define MDSPAN_NEEDS_TRAIT_VARIABLE_TEMPLATE_BACKPORTS 1
#    endif
#  endif
#endif

#ifndef MDSPAN_USE_VARIABLE_TEMPLATES
...
#    define MDSPAN_USE_VARIABLE_TEMPLATES 1
#  endif
#endif // MDSPAN_USE_VARIABLE_TEMPLATES

#ifndef MDSPAN_USE_CONSTEXPR_14
#  if (defined(__cpp_constexpr) && __cpp_constexpr >= 201304) \
        || (!defined(__cpp_constexpr) && MDSPAN_HAS_CXX_14) \
        && (!(defined(__INTEL_COMPILER) && __INTEL_COMPILER <= 1700))
#    define MDSPAN_USE_CONSTEXPR_14 1
#  endif
#endif

#ifndef MDSPAN_USE_INTEGER_SEQUENCE
#  if defined(MDSPAN_COMPILER_MSVC)
#    if (defined(__cpp_lib_integer_sequence) && __cpp_lib_integer_sequence >= 201304)
#      define MDSPAN_USE_INTEGER_SEQUENCE 1
#    endif
#  endif
#endif
#ifndef MDSPAN_USE_INTEGER_SEQUENCE
...
#    define MDSPAN_USE_INTEGER_SEQUENCE 1
#  elif defined(MDSPAN_COMPILER_APPLECLANG) && MDSPAN_HAS_CXX_14
...
#ifndef MDSPAN_USE_RETURN_TYPE_DEDUCTION
#  if (defined(__cpp_return_type_deduction) && __cpp_return_type_deduction >= 201304) \
          || (!defined(__cpp_return_type_deduction) && MDSPAN_HAS_CXX_14)
#    define MDSPAN_USE_RETURN_TYPE_DEDUCTION 1
#  endif
#endif

#ifndef MDSPAN_USE_CLASS_TEMPLATE_ARGUMENT_DEDUCTION
...
#    define MDSPAN_USE_CLASS_TEMPLATE_ARGUMENT_DEDUCTION 1
#  endif
#endif

#ifndef MDSPAN_USE_STANDARD_TRAIT_ALIASES
...
#    define MDSPAN_USE_STANDARD_TRAIT_ALIASES 1
#  elif defined(MDSPAN_COMPILER_APPLECLANG) && MDSPAN_HAS_CXX_14
...
#ifndef MDSPAN_DEFAULTED_CONSTRUCTORS_INHERITANCE_WORKAROUND
#  ifdef __GNUC__
#    if __GNUC__ < 9
#      define MDSPAN_DEFAULTED_CONSTRUCTORS_INHERITANCE_WORKAROUND 1
#    endif
#  endif
#endif
...
#    if defined(MDSPAN_COMPILER_CLANG) && ((__clang_major__ == 15) || (__clang_major__ == 16))
...
#if MDSPAN_USE_BRACKET_OPERATOR
#  define MDSPAN_OP(mds,...) mds[__VA_ARGS__]
...
#  define MDSPAN_OP0(mds) mds.accessor().access(mds.data_handle(),0)
#else
#  define MDSPAN_OP0(mds) mds[]
#endif
#  define MDSPAN_OP1(mds, a) mds[a]
#  define MDSPAN_OP2(mds, a, b) mds[a,b]
#  define MDSPAN_OP3(mds, a, b, c) mds[a,b,c]
#  define MDSPAN_OP4(mds, a, b, c, d) mds[a,b,c,d]
#  define MDSPAN_OP5(mds, a, b, c, d, e) mds[a,b,c,d,e]
#  define MDSPAN_OP6(mds, a, b, c, d, e, f) mds[a,b,c,d,e,f]
#else
#  define MDSPAN_OP(mds,...) mds(__VA_ARGS__)
#  define MDSPAN_OP0(mds) mds()
#  define MDSPAN_OP1(mds, a) mds(a)
